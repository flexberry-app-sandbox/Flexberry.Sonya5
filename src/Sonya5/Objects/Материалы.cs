...
namespace IIS.Sonya5
{
    ...
    public class Материалы : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Sonya5.Единицы fЕдиницы;
        ...
        public virtual IIS.Sonya5.Единицы Единицы
        {
            get
            {
                ...
                IIS.Sonya5.Единицы result = this.fЕдиницы;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View МатериалыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("МатериалыE", typeof(IIS.Sonya5.Материалы));
                }
            }
            ...
            public static ICSSoft.STORMNET.View МатериалыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("МатериалыL", typeof(IIS.Sonya5.Материалы));
                }
            }
        }
    }
